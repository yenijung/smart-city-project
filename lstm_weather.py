...
x_train, y_train, x_val, y_val, sc1, sc2 = prepare_dataset(combined_train, df_validation, time_steps, n_forecast)

# Create the LSTM model
lstm_model = build_model(time_steps, features, n_forecast, units, num_layers, learning_rate)

# # Train the model
# lstm_model.fit(x_train, y_train, validation_data=(x_val, y_val), epochs=50, batch_size=batch_size, verbose=1)
#
# # Save the model
# lstm_model.save('Models/best_model_weather.h5')
